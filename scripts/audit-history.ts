 ...
 * HISTORY_DATABASE_URL_2 in prod). Prints, for the last 14 Sydney days and per
 * country: row count, distinct cards, and min/median/max lowestPriceCents — so a
 * gap (missing recent days) or a scale jump (broken index) is obvious in the log.
 * Also prints which DB it actually connected to.
 *
