...
import { NOT_SEED_WHERE, EARLY_PREMIUM_LIMIT, EARLY_PREMIUM_MONTHS } from "../src/lib/premium";
...
async function main() {
  ...
  console.log(`Early-adopter promo granted: ${earlyGranted} (limit ${EARLY_PREMIUM_LIMIT}, ${EARLY_PREMIUM_MONTHS} months each)`);
