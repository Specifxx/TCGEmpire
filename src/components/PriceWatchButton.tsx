...
export function PriceWatchButton({
  ...
  // A HEART, not a bell (2026-09-21, owner: "the wishlist icon should be a
  // heart and not a bell"). Changed HERE as well as in the header, not only
  // there: HeaderWatchButton's own doc comment records that an earlier pass
  // made the header disagree with this control and it was reverted with "it
  // should be the same icon as the watch has". One concept, one glyph.
  const bell = (
    <svg
      viewBox="0 0 24 24"
      className="h-4 w-4"
