...
export function MoversToolsCta() {
  ...
  if (premium) {
    return (
      <section className="card-surface p-5">
        <h2 className="text-lg font-bold text-white">Your flipper tools</h2>
        ...
        <div className="mt-3 flex flex-wrap gap-2">
          ...
          <Link href="/tools/arbitrage" className="btn-ghost text-sm">Arbitrage finder →</Link>
        </div>
      </section>
    );
  }
  ...
  return (
    <section className="card-surface relative overflow-hidden p-5">
      ...
      <h2 className="text-lg font-bold text-white">For flippers &amp; investors</h2>
      <p className="mt-1 max-w-xl text-sm text-slate-400">
        ...
        average, and the <strong className="text-slate-200">Arbitrage finder</strong> lists cards you can buy cheap
        and flip to eBay for a profit — the full lists, ranked.
      </p>
      <div className="mt-3 flex flex-wrap items-center gap-2">
        <PremiumButton />
        <Link href="/tools/value-finder" className="btn-ghost text-sm">Preview Value Finder →</Link>
        <Link href="/tools/arbitrage" className="btn-ghost text-sm">Preview Arbitrage →</Link>
      </div>
    </section>
  );
}
