...
export async function EbayAdCarousel({ cardId, query, className }: { cardId: string; query: string; className?: string }) {
  ...
  return <EbayAdCarouselLive listings={rows as AdListing[]} query={query} className={className} />;
}
