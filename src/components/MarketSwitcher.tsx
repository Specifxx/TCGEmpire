  ...
  return (
    <label className="inline-flex items-center gap-2 text-xs text-slate-400">
      ...
      <select
        ...
        className="rounded-lg border border-ink-700 bg-ink-900 px-2.5 py-1.5 text-sm font-medium text-slate-100 hover:bg-ink-800 focus:border-brand-500 focus:outline-none"
      >
        {OPTIONS.map((o) => (
