          ...
          >
            <div className="relative aspect-[5/7]">
              {h.imageThumbUrl ? (
                ...
                <img {...cardThumbProps({ imageThumbUrl: h.imageThumbUrl }, "(max-width: 640px) 50vw, 200px")} alt={cardImageAlt(h)} loading="lazy" decoding="async" className="h-full w-full object-cover" />
              ) : (
