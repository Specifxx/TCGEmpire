...
type PricedCard = { lowestPriceCents: number | null; lowestPriceCentsUs?: number | null; lowestPriceCentsUk?: number | null; lowestPriceCentsCa?: number | null; lowestPriceCentsSg?: number | null; lowestPriceCentsDe?: number | null };
...
export function CountryProvider({ initial, children }: { initial: Country; children: React.ReactNode }) {
  ...
  // Vercel's IP-country header) so AU/US/UK/SG/CA/DE visitors still land on
