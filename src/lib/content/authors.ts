...
export const AUTHORS: Author[] = [
  {
    ...
    bio: [
      "RiftCompare is an independent price-comparison site for Riftbound: League of Legends TCG, tracking singles and sealed product across stores in Australia, the United States, the United Kingdom, Singapore, Canada and Germany.",
