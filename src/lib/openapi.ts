...
const MARKET_ENUM = ["AU", "NZ", "US", "UK", "SG", "CA"] as const;
...
const MARKET_PARAM_WITH_GLOBAL = {
  ...
  description: "Market scope; GLOBAL is a currency-agnostic composite across all six markets.",
};
    ...
    paths: {
      ...
      "/api/v1/card/{id}/prices.json": {
        get: {
          ...
          summary: "Lowest live in-stock price in EVERY market (AU/NZ/US/UK/SG/CA) for one card, in a single response.",
          description:
                ...
                "application/json": {
                  schema: {
                    ...
                    properties: {
                      ...
                      prices: {
                        type: "object",
                        description: "One entry per market code (AU/NZ/US/UK/SG/CA).",
