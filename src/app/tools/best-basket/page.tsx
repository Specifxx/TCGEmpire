...
const FAQS = [
  {
    ...
    a: "It's part of RiftCompare Premium, alongside Value Finder, Rising Cards, the full Deal Finder list and a reduced marketplace fee. A free account still gets the deck pricer at /deck for per-card prices.",
  },
  {
