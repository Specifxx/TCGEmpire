...
const FAQS = [
  ...
  },
  {
    ...
    a: "RiftCompare compares live prices across stores in Australia, the US, the UK, Singapore, Canada and Germany, ranked by total delivered cost including postage. Radiance cards appear on the set page with real prices as soon as stores list them.",
  },
];
