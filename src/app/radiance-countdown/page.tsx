...
const FAQS = [
  ...
  },
  {
    ...
    a: "RiftCompare compares live prices across stores in Australia, New Zealand, the US, the UK, Singapore and Canada, ranked by total delivered cost including postage. Radiance cards appear on the set page with real prices as soon as stores list them.",
  },
];
