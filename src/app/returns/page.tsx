      ...
      <div className="mt-8 space-y-8 border-t border-ink-800 pt-8 text-sm leading-relaxed text-slate-300">
        ...
        <section className="space-y-2">
          ...
          <p>
            ...
            Consumer Law, the UK Consumer Rights Act, the New Zealand Consumer Guarantees Act, applicable Canadian
            provincial consumer protection law, and applicable US state and federal consumer protection law. Where
            those rights are broader than this policy, they apply.
          </p>
        </section>
