...
export async function generateMetadata({ params }: { params: { slug: string } }): Promise<Metadata> {
  ...
  // A post with no file-based counterpart is an AUTO-GENERATED daily market report
  // (one per calendar day, forever, built from a template — see lib/market-report.ts).
  // Those are noindexed: an unbounded run of near-duplicate machine-written pages is
  // exactly what Google's "scaled content abuse" spam policy targets, and a live
  // Publisher-Policy/AdSense liability. They stay fully readable for humans (homepage
  // banner + /market/wrap archive) and keep follow so their outbound links still pass
  // signal — we just stop asking Google to index them. See also src/app/sitemap.ts.
