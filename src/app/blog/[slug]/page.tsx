...
export async function generateMetadata({ params }: { params: { slug: string } }): Promise<Metadata> {
  ...
  // Single-candidate ladder (hand-authored copy has no shorter fallback to step
  // down to) — buildTitle/buildDescription still cap it: drop the suffix, then
  // clamp, rather than let a long title/excerpt run past budget untouched.
  const description = buildDescription([a.excerpt]);
  return {
    title: buildTitle([a.title], " — RiftCompare Blog"),
    description,
