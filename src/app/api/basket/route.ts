...
// user, free or Premium. Resolve the requested cards — either a structured list of
// exact printings (the primary search-and-add flow) or a pasted decklist (the
// advanced/paste fallback) — pull every in-stock STORE listing in the viewer's market
// (eBay excluded — its per-item postage isn't comparable), and return the cheapest
// landed plan.
