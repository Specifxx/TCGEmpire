                  ...
                  <td className="px-3 py-2">
                    <Link href={`/card/${p.slug ?? p.id}`} className="flex items-center gap-2.5">
                      {p.imageThumbUrl && (
                        ...
                        <img {...cardThumbProps({ imageThumbUrl: p.imageThumbUrl }, "26px")} alt={cardImageAlt({ name: p.displayName, setCode: p.setCode, collectorNumber: p.collectorNumber })} width={26} height={36} loading="lazy" decoding="async" className="h-9 w-[26px] shrink-0 rounded-sm object-cover" />
                      )}
