# RiftCompare — Promo kit (ready to paste)

Copy-paste posts for the channels that need a real human account. Post as **the
founder**, in **self-promo / "share your project" threads** where it's welcome —
that's legitimate and effective. (Don't mass-post the same thing everywhere at
once; space it out and tweak per community so it reads naturally.)

Swap in real numbers where you see `[…]`.
...
### X / Twitter — short thread (optional)
...
4/ It's free and needs no login. If you collect or play Riftbound, give it a go and tell me what's missing 👇 https://riftcompare.com

---

## Reddit — intro post (use in r/Riftbound or LoL/TCG self-promo threads)

**Title:** I built a free price-comparison tool for Riftbound — find the cheapest card across every store

**Body:**
> Hey all — I play Riftbound and kept wasting time checking shop after shop to find the cheapest copy of a card, so I built a tool to do it for me: **RiftCompare** (https://riftcompare.com).
>
> What it does:
...
>
> It's still early and I'm actively improving it — would genuinely love feedback on what's inaccurate or what you'd want added. Thanks!

*(Reddit tip: read each subreddit's self-promotion rules first; many have a weekly "show off your project" or "no-stupid-questions" thread that's the right place. Reply to comments — engagement is what makes a post land.)*
...
## Where to share (legit, founder-posted)

- **r/Riftbound** and LoL / TCG subreddits' self-promo threads
- **Riftbound / LoL TCG Discord servers** (#tools / #resources, or ask mods)
- **X/Twitter** with #Riftbound #LoLTCG and tagging relevant community accounts
- **Facebook groups** for Riftbound / LoL TCG
- **Directories:** Product Hunt, AlternativeTo, SaaSHub, BetaList, indie-maker lists
- **Other Riftbound sites** (RiftDecks, Piltover Archive, RiftMana) — partnership/backlink outreach emails are the highest-ROI move; ask them to add a "buy / price check" link to RiftCompare.

> Reminder: real backlinks from those Riftbound sites do more for traffic + Google
> ranking than any single post. Prioritise the partnership emails.
